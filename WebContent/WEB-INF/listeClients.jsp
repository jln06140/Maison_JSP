...
<body>
    <div class="contenu">
        ...
        <div class="container">
            ...
            <tr>
            	<td><c:out value="${reservation.client.nom }"></c:out>
            	<td><c:out value="${reservation.client.prenom }"></c:out>
            	<td><c:out value="${reservation.client.telephone }"></c:out>
            	<td><c:out value="${reservation.client.email }"></c:out>
            	<td><c:out value="${reservation.client.nom }"></c:out>
            </tr>
