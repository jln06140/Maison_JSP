		...
		<div class="container">
			...
			<form class="col s12" method="POST" id="formulaire" name="formulaire"
				...
				<div class="row">
					...
					<div class="input-field col s12 m6 l6">
						<i class="material-icons prefix">edit</i> <label for="prenom">Prenom
							: </label> <input type="text" id="prenom" name="prenom" value="" />
				...
				<div class="row">
					...
					<div class="input-field col s12 m6 l6">
						<i class="material-icons prefix">mail</i> <label for="email">email
					...
					<div class="input-field col s12 m6 l6">
						<i class="icones material-icons prefix">phone</i> <label
							for="telephone">Telephone : </label> <input type="text"
				...
				<div class="row">
					...
					<div class="col s12 m8 l8" id="checkbox1">
						...
						<p class="col s4 m4 l4">
							<input type="checkbox" class="filled-in" id="Parking"
								name="Parking" value="Parking" /> <label for="Parking">Parking</label>
						</p>
						<p class="col s4 m4 l4">
							<input type="checkbox" class="filled-in" id="Animal"
								name="Animal" value="Animal" /> <label for="Animal">Animal</label>
						</p>
						<p class="col s4 m4 l4">
							<input type="checkbox" class="filled-in" id="Fumeur"
								name="Fumeur" value="Fumeur" /> <label for="Fumeur">Fumeur</label>
						</p>
				...
				<div id="lesbouttons" class="row">
					...
					<div id="reserver" class="bouton col S12 m5 l5">
						<button id="reserver" class="btn waves-effect waves-light"
							...
							Reserver <i class="material-icons right">send</i>
						</button>
					</div>
